...
?>
		    ...
		    <tr>
			<td height="22" align="center" valign="middle"><?php echo $items['pdo_type'];?></td>
			<td align="center" valign="middle"><?php echo $items['db_name'];?></td>
			<td align="center" valign="middle"><?php echo $items['dates'];?></td>
			<td align="center" valign="middle"><a href="index6delete.php?action=del&conn_id=<?php echo $items['pdo_type']; ?>">删除</a></td>
			</tr>
